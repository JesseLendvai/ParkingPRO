...
<p>Welkom bij Lelystad parkeren bedankt voor uw keuze!<br>U kunt <a href='$_SERVER['SERVER_NAME'];parkingpro/pages/login.php?token=". $auth_key ."'>hier</a> klikken om in te loggen.</p>
</body>
</html>
";
